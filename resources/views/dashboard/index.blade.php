...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="{{ URL::to('/') }}">SIRUSA</a></h1>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            ...
            <h2>Membantu Anda Menghemat Waktu, Uang,</h2>
            <h2>dan Meningkatkan Kepuasan Pasien</h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="content">
                            <h3>Mengapa Memilih SIRUSA?</h3>
                            <p>
                                Di SIRUSA, kami memahami bahwa kesehatan Anda adalah prioritas utama. Oleh karena itu,
                                kami menghadirkan SIRUSA, Sistem Informasi Rumah Sakit (SIRUSA) yang dirancang untuk
                                memberikan perawatan kesehatan terbaik bagi Anda
                            </p>
                            ...
                            <div class="row">
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>SIRUSA dirancang dengan antarmuka yang mudah digunakan, sehingga mudah
                                            dipelajari dan digunakan oleh semua staf rumah sakit.</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>SIRUSA menerapkan standar keamanan informasi yang ketat untuk melindungi data
                                            pasien</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <h4>Didukung oleh tim yang berpengalaman</h4>
                                        <p> SIRUSA didukung oleh tim yang berpengalaman dalam pengembangan dan
                                            implementasi sistem informasi rumah sakit.</p>
                                    </div>
                                </div>
                            </div>
                        </div><!-- End .content-->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div
                        ...
                        <h3>Fitur Utama Sistem Informasi Rumah Sakit</h3>
                        <p>SIRUSA dilengkapi dengan berbagai fitur utama yang dirancang untuk membantu rumah sakit dalam
                            mengoptimalkan operasional dan meningkatkan kualitas pelayanan pasien. Berikut adalah
                            beberapa fitur utama SIRUSA :</p>

                        <div class="icon-box">
                            <div class="icon"><i class="bx bx-fingerprint"></i></div>
                            <h4 class="title"><a href="">Manajemen Pasien</a></h4>
                            <p class="description">SIRUSA menyediakan fitur untuk mengelola data pasien, termasuk
                                pendaftaran pasien, riwayat kesehatan, rekam medis, dan informasi asuransi.</p>
                        </div>

                        <div class="icon-box">
                            <div class="icon"><i class="bx bx-gift"></i></div>
                            <h4 class="title"><a href="">Manajemen Rekam Medis</a></h4>
                            <p class="description">SIRUSA menyediakan fitur untuk mengelola rekam medis pasien secara
                                elektronik, termasuk penyimpanan, akses, dan berbagi rekam medis dengan dokter dan
                                tenaga medis lainnya.</p>
                        </div>

                        <div class="icon-box">
                            <div class="icon"><i class="bx bx-atom"></i></div>
                            <h4 class="title"><a href="">Manajemen Operasional</a></h4>
                            <p class="description">SIRUSA menyediakan fitur untuk mengelola operasional rumah sakit,
                                termasuk penjadwalan operasi, manajemen obat, dan manajemen persediaan.</p>
                        </div>
                    </div>
                </div>
