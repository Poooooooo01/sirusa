...
class ConversationDoctorController extends Controller
{
    public function show($consultation_id)
    {
        ...
        return view('doctor.appointment.conversation', compact('messages', 'consultation_id', 'consultation')); // Kirim variabel $consultation ke tampilan
    }
